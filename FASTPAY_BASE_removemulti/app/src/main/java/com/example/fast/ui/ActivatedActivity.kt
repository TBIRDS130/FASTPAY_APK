...
class ActivatedActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ProcessLog.start("ActivatedActivity_onCreate")
        ...
        ProcessLog.stop("ActivatedActivity_onCreate")
    }
    ...
    private fun setupTransitions() {
        ProcessLog.start("ActivatedActivity_setupTransitions")
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            try {
        ...
        ProcessLog.stop("ActivatedActivity_setupTransitions")
    }
    ...
    private fun loadBrandingConfig() {
        ProcessLog.start("ActivatedActivity_loadBrandingConfig")
        try {
        ...
        val taglineView = id.textView12
                ...
                ProcessLog.stop("ActivatedActivity_loadBrandingConfig")
            }
        } catch (e: Exception) {
    ...
    private fun initializeManagers() {
        ProcessLog.start("ActivatedActivity_initializeManagers")
        // UI Manager
        ...
        ProcessLog.stop("ActivatedActivity_initializeManagers")
    }
     ...
     */
    private fun setupUI() {
        ProcessLog.start("ActivatedActivity_setupUI")
        ...
        ProcessLog.stop("ActivatedActivity_setupUI")
    }
    ...
    private fun setupButtons() {
        ProcessLog.start("ActivatedActivity_setupButtons")
        try {
            buttonManager.setupButtons()
        } catch (e: Exception) {
            LogHelper.e("ActivatedActivity", "Error in setupButtons", e)
        }
        ProcessLog.stop("ActivatedActivity_setupButtons")
    }
    ...
    override fun onResume() {
        ProcessLog.start("ActivatedActivity_onResume")
        super.onResume()
        serviceManager.ensureServiceRunning()
        checkPermissionsAndUpdateUI()
        ...
        ProcessLog.stop("ActivatedActivity_onResume")
    }
