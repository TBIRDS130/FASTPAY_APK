...
class ActivatedUIManager(
    ...
    private fun showAllElementsImmediately() {
        ProcessLog.start("ActivatedUI_showAllImmediately")
        ...
        ProcessLog.stop("ActivatedUI_showAllImmediately")
    }
    ...
    private fun hideElementsForAnimation() {
        ProcessLog.start("ActivatedUI_hideForAnimation")
        ...
        binding.testButtonsContainer.visibility = View.VISIBLE
        ProcessLog.stop("ActivatedUI_hideForAnimation")

        // Animate cards and buttons in
        ProcessLog.start("ActivatedUI_cards_animate_in")
        ...
        binding.testButtonsContainer.animate()
            ...
            .setDuration(500)
            .setStartDelay(500)
            .withEndAction { ProcessLog.stop("ActivatedUI_cards_animate_in") }
            .start()
    }
